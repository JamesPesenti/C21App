    ...
    <ScrollView style={{ backgroundColor: "white"}}>
        ...
        <View style={styles.reviewContainer}>
          <Text style={styles.meetTitle}>What Clients Are Saying</Text>
            <Image 
              style={{width: 55, height: 55, resizeMode: "contain", borderRadius: 100, marginTop: 20, marginBottom: -60}}
        ...
        <View style={styles.connectContainer}>
          ...
          <Text style={styles.letsTitle}>Let's Connect</Text>
            <Text style={styles.description}>For the best results and service when it comes to all of your real estate needs, reach out anytime.</Text>
            <Pressable
              onPress={() => {}}
              style={styles.learnMoreButton}
            >

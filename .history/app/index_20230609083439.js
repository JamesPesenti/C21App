    ...
    <ScrollView style={{ backgroundColor: "white"}}>
        ...
        <View style={styles.meetContainer}>
          ...
          <Text style={styles.meetTitle}>Meet Pedro Guerra</Text>
            <Text numberOfLines={1} style={styles.description}>Pedro is dedicated to client service and believes in going the extra mile to exceed expectations, which has proved to make him a highly successful realtor best positioned to help you with your real estate goals.</Text>
            <Pressable
              onPress={() => {}}

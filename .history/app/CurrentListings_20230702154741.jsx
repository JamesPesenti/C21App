                     ...
                     />
                      <View style={styles.listingInfo}>
                       ...
                       <View style={{flexDirection: "row", gap: 20}}>
                          <Text style={styles.listingBedBath}>{item.beds} Beds</Text>
                          <Text style={styles.listingBedBath}>{item.beds} Baths</Text>
                          <Text style={styles.listingBedBath}>{item.SqFt} Sq Ft</Text>
                       </View>
                    </View>
                  </TouchableOpacity>
                  </>

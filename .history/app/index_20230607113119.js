    ...
    <ScrollView style={{ backgroundColor: "white"}}>
        ...
        <View style={styles.reviewsContainer}>
          <Text style={styles.meetTitle}>What Clients Are Saying</Text>
            <Image 
              style={{width: 50, height: 50, resizeMode: "contain", borderRadius: 50}}
              source={{ uri: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQSbNNCN6Cr-fvnp5eIKCXmz4X24z4vy0FImQ&usqp=CAU" }}
            />
            <FlatList
              horizontal
              data={reviews}

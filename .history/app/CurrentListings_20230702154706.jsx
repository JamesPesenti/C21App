                     ...
                     />
                      <View style={styles.listingInfo}>
                       ...
                       <View style={{flexDirection: "row"}}>
                          <Text style={styles.listingBedBath}>{item.bedsBathSqft} {item.beds} Beds</Text>
                          <Text style={styles.listingBedBath}>{item.bedsBathSqft} {item.beds} Baths</Text>
                          <Text style={styles.listingBedBath}>{item.bedsBathSqft} {item.SqFt} Sq Ft</Text>
                       </View>
                    </View>
                  </TouchableOpacity>
                  </>

           ...
           <View >
              <Image
                ...
                <div className={styles.priceContainer}>
                  <p style={{fontSize: 22, color: "azure"}}>$435,000</p>
                </div>
                <div className={styles.statusContainer}>
                  <p style={{fontSize: 18, color: "white"}}>For Sale</p>
                </div>
           </div>
            <p>637 N Monticello Ave Chicago, IL 60624</p>
            <p> 4 beds | 4 bath | 2,000 sq. ft.</p>
        </View>
        {/* Reviews */}

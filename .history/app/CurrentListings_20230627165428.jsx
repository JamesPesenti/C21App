import { Dimensions, ScrollView, StyleSheet, Image, TouchableOpacity, Text, View } from 'react-native'
...
const CurrentListings = () => {
  ...
  return (
    <>
    <ScrollView>
     <Text style={{ justifyContent: "center", textAlign: "center", marginTop: 80, fontSize: 30, color: 'bronze' }}>Current Listings</Text>
       <ScrollView
         horizontal

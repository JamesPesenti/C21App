   ...
   <>
      ...
      {/* Footer */}
        <View style={styles.footerContainer}>
         <Text>Century 21 Universal </Text>
         <Image 
          style={{width: 100, height: 150, borderRadius: "100%", resizeMode: "contain"}}
          source={{ uri: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQUp_k5f_wNyLr6XstmLkc_kvBZ409NZyedQQ&usqp=CAU"}}
         />
        </View>
    </ScrollView>
   </>

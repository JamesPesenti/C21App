   ...
   <>
    ...
    >
       ...
       {/* Meet Me Section */}
        ...
        <View>
            <Text style={{ fontSize: 30, color: 'black' }}>My Listings</Text>
           <View >
              <Image
                  style={{marginTop: 40, height: 250, width: 200}}
                  source={require("./assets/images/property1")}
                />
                <View className={styles.priceContainer}>
                  <Text style={{fontSize: 22, color: "azure"}}>$435,000</Text>
                </View>
                <View className={styles.statusContainer}>
                  <Text style={{fontSize: 18, color: "white"}}>For Sale</Text>
                </View>
           </View>
            <Text>637 N Monticello Ave Chicago, IL 60624</Text>
            <Text> 4 beds | 4 bath | 2,000 sq. ft.</Text>
        </View>

...
export default function Page() {
  ...
  return (
    <ScrollView fadingEdgeLength={20} showVerticalScrollbar={false} style={{ backgroundColor: "white"}}>
      <View style={styles.container}>
        ...
        <View style={{marginTop: 0}}>
          ...
          <View style={styles.buttonsContainer}>
            <Link href="/searchHomes" style={[styles.searchButton, styles.searchContactText]}>
              <Text>Search Homes</Text>
            </Link>
            <Link href="/contactModal" style={[styles.contactButton, styles.searchContactText]}>

           ...
           <View style={styles.imageContainer}>
              {currentListings.map((item) => {
                 return (
                  ...
                  >
                     <Image
                        style={{resizeMode: "contain", marginTop: 20, height: 120, width: 180}}
                        source={item.image}
                     />
                      <Text style={{fontSize: 10, fontWeight: "bold"}}>637 N Monticello Ave Chicago, IL 60624</Text>
            <Text style={{fontSize: 10}}> 4 beds | 4 bath | 2,000 sq. ft.</Text>
                  </TouchableOpacity>
                  </>
                 )
              })}

  ...
  return (
    <>
      ...
      <View style={styles.meetContainer}>
        ...
        <Text numberOfLines={2} style={styles.description}>Our team is dedicated to excellent client service and always believe in going the extra mile to exceed expectations, making Ximena & Pedro highly successful realtors best positioned to help you with all your real estate goals.</Text>
            <Link 
              href="/learnMore"

           ...
           <View style={styles.imageContainer}>
              {currentListings.map((item) => {
                 return (
                  ...
                  >
                     <Image
                        style={{ marginHorizontal: 5, borderRadius: 5, resizeMode: "cover", marginTop: 20, height: 100, width: 120}}
                        source={item.image}
                     />
                      <Text style={{marginLeft: -10, fontSize: 10, fontWeight: "bold"}}>{item.address}</Text>

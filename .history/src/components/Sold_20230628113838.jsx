              ...
              {soldProperties.map((item) => {
                 return (
                  ...
                  <TouchableOpacity
                     ...
                     onPress={() => router.push("https://www.rdeskwebsite.com/ximena-alban/listing/listingsearchresultsonly.aspx?Search=8c0f7a56-b152-4c5d-9768-1086f4320545&SearchType=AgentHome&InternalAgentCd=&OfficeCds=&AgentHomePageSearchType=PriorSales&ListingType=&ListingDistrictTypeID=&PriorSales=&Sort=6")}
                  >
                     <Image

  ...
  return (
    <>
      ...
      <View style={styles.meetContainer}>
        ...
        <Text numberOfLines={2.5} style={styles.description}>Our team is dedicated to excellent client service and always believes in going the extra mile to exceed expectations, which has proved to make him a highly successful realtor best positioned to help you with your real estate goals.</Text>
            <Link 
              href="/learnMore"
